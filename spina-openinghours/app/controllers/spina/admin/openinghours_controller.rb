    ...
    class OpeninghoursController < AdminController
      ...
      def update
        ...
        if @openinghour.update_attributes(openinghour_params)
          redirect_to spina.admin_openinghours_url, notice: "Openingstijden van #{I18n.t('date.day_names')[@openinghour.day]} opgeslagen"
        else
          render :edit
        end
      end
      ...
      def set_breadcrumb
        add_breadcrumb "Openingstijden", spina.admin_openinghours_path
      end
