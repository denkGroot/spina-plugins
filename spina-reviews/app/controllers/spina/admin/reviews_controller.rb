module Spina
  module Admin
    class ReviewsController < AdminController
      ...
      def new
        add_breadcrumb "Nieuwe beoordeling", spina.new_admin_review_path
      ...
      def create
        ...
        if @review.save
          redirect_to spina.admin_reviews_url, notice: "Beoordeling is aangemaakt."
        else
          render :new
        end
      end
      ...
      def update
        ...
        if @review.update_attributes(review_params)
          redirect_to spina.admin_reviews_url, notice: "Beoordeling van #{@review.name} opgeslagen"
        else
          render :edit
        end
      end
      ...
      def set_breadcrumb
        add_breadcrumb "Beoordelingen", spina.admin_reviews_path
      end
