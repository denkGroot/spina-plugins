    ...
    module Admin
      class ReviewsController < ::Spina::AdminController
        ...
        def create
          ...
          if @review.save
            redirect_to spina.reviews_admin_reviews_url, notice: "Beoordeling is aangemaakt."
          else
            render :new
          end
        end
        ...
        def update
          ...
          if @review.update_attributes(review_params)
            redirect_to spina.reviews_admin_reviews_url, notice: "Beoordeling van #{@review.name} opgeslagen"
          else
            render :edit
          end
        end
        ...
        def destroy
          @review = Review.find(params[:id])
          @review.destroy
          redirect_to spina.reviews_admin_reviews_url, notice: "De beoordeling is verwijderd."
        end
        ...
        def confirm
          ...
          @review.save
          redirect_to spina.reviews_admin_reviews_url
        end
